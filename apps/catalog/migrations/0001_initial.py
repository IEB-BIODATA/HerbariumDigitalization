    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('orden', models.CharField(blank=True, max_length=300, null=True)),
                ...
                ('habito', models.CharField(blank=True, max_length=300, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('habito', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='catalog.habit')),
                ('region_distribution', models.ManyToManyField(blank=True, to='catalog.region')),
        ...
        migrations.AddField(
            model_name='family',
            name='orden',
            field=models.ForeignKey(blank=True, help_text='Orden', null=True, on_delete=django.db.models.deletion.CASCADE, to='catalog.order'),
        ),
        migrations.CreateModel(
            name='Division',
            fields=[
