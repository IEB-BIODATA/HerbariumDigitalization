...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.ImageField(blank=True, null=True, storage=apps.digitalization.storage_backends.IAPrivateMediaStorage(), upload_to='', verbose_name='Escala de imagen 10 veces más pequeña'),
        ),
        migrations.AlterField(
            model_name='voucherimported',
            name='image_resized_60',
            field=models.ImageField(blank=True, null=True, storage=apps.digitalization.storage_backends.IAPrivateMediaStorage(), upload_to='', verbose_name='Escala de imagen 60 veces más pequeña'),
        ),
    ]
